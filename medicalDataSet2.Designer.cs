...
namespace MedProject.medicalDataSet2TableAdapters {
    ...
    public partial class PatientTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Patient] SET [name] = @name WHERE (([id] = @Original_id));\r\nSELECT " +
                "id, name FROM Patient WHERE (id = @id)";
        ...
        public virtual int Fill(medicalDataSet2.PatientDataTable dataTable) {
        ...
        public virtual medicalDataSet2.PatientDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            medicalDataSet2.PatientDataTable dataTable = new medicalDataSet2.PatientDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(medicalDataSet2.PatientDataTable dataTable) {
